...
As the countdown to December 25th began, the unthinkable happened. Somewhere deep inside the Holiday Algorithm, something went horribly wrong. Instead of neatly organising the Naughty/Nice lists and gift orders, the algorithm started spitting out _nonsense_:
...
The elves stared at the screens, horrified. "This... this can't be right!" said Tinker, the coding intern elf. No one dared to tell Santa. "Is this... a stack overflow?" "No," murmured Jingle, the head elf, trembling. "It's worse. **It's a heap of bugs.**"
...
The input file will be in a particular format. The first line contains an integer, \`N\`. \`N\` lines follow, each containing two integers separated by a space, representing the \`x\` and \`y\` coordinates of the point.
